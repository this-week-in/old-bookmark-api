 ...
 */
public class ResourceserverApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new ResourceserverApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new ResourceserverApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
