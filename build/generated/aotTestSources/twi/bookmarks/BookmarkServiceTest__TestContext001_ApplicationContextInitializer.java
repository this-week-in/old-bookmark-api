 ...
 */
public class BookmarkServiceTest__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new BookmarkServiceTest__TestContext001_BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new BookmarkServiceTest__TestContext001_BeanFactoryRegistrations().registerAliases(beanFactory);
  }
